...
const Users = () => {
    ...
    const changeStatus = () => {
        ...
        const successMessage =
            user.isAccountLocked === false ? "User Successfully Deactivated." : "User Successfully Activated.";
        const errorMessage =
            user.isAccountLocked === false ? "Error while deactivating user." : "Error while activating user.";
        ...
        return (
            <div className="actions flex">
                <Button
                    ...
                    onClick={() => showEditUserDialog(rowData)}
                />
                <Button
                    icon="pi pi-trash"
                ...
                <Button
                    ...
                    onClick={() => showRoleUpdateDialog(rowData)}
                />
            </div>
        );
    };
    ...
    return (
        <div className="grid">
                            ...
                            <div className="p-fluid  grid card mt-2 ">
                                ...
                                <span className=" mt-5 col-12 ">
                                    <PhoneInput
                                        ...
                                        className={
                                            errors.phoneNumber ? "error-input input-phone-number" : "input-phone-number"
                                        }
                                    />
                            ...
                            <div className="p-fluid  grid card mt-2 ">
                                ...
                                <span className="col-6 mt-3">
                                    <Button
                                        ...
                                        className="p-button-outlined warning"
                                        raised
                                    />
                                </span>
                                <span className="col-6 mt-3 ">
            ...
            <Dialog
                ...
                header="Confirm"
                modal
                footer={changeStatusRoleDialogFooter}
                ...
                <div className="flex align-items-center justify-content-center">
                    ...
                    {user && (
                        <span>
                            ...
                            <b>
                                {user.isAccountLocked === false ? "Deactivate" : "Activate"} {user.firstName}{" "}
                                {user.lastName}
                            </b>
                            ?
                        </span>
